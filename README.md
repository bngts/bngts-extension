...
- **그룹 기능**: 스트리머를 그룹별로 분류하여 편리하게 관리
- **필터링**: 전체/온라인/오프라인 필터
- **정렬**: 커스텀/이름순/라이브 우선순
- **직관적인 UI**: 스트리머 목록을 한눈에 파악할 수 있는 개선된 인터페이스

### 알림 기록

- 받은 방송 알림 내역을 확인할 수 있는 알림 기록 기능
...
- **치지직**: 자동 와이드 모드 전환, 채팅창 헤더 접기 버튼 자동 클릭, **선호 화질 자동 선택**
- **SOOP**: 임베드 모드에서 채팅 영역 숨김, 화질 선택 박스 표시, 다크 모드 자동 적용, **선호 화질 자동 선택**

### 선호 화질

치지직/SOOP 사이트 및 방통실 멀티뷰에서 기본으로 재생될 화질을 설정할 수 있습니다. 영상은 설정된 선호 화질로 자동 전환됩니다.

- **치지직**: 1080p/720p/480p/360p/자동 중 선택
- **SOOP**: 1440p/1080p/720p/540p/360p/자동 중 선택
